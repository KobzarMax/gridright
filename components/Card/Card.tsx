...
const Card = ({ iconSrc, title, description }: CardProps) => {
  return (
    <div className="bg-white/11 border border-white rounded-[30px] p-2.5 xl:p-4 2xl:p-6 backdrop-blur-[25px] flex flex-col items-start gap-5 sm:gap-10 lg:gap-16 2xl:gap-20">
      {iconSrc && (
