...
const Card = ({ iconSrc, title, description }: CardProps) => {
  return (
    <div className="bg-white/11 border border-white rounded-[30px] p-2.5 md:p-6 backdrop-blur-[25px] flex flex-col items-start  gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-23.5">
      {iconSrc && (
